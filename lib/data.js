...
(function () {
  ...
  const DEFAULTS = {
    ...
    pillars: [
      ...
      { number: '03', tag: 'Growth',       title: 'Concurrency or Bust.',     body: "No new subdivisions where the schools, roads, and stormwater can't keep up. Build infrastructure first." },
    ...
    issues: [
      ...
      { slug: 'concurrency', number: '03', tag: 'Growth',       title: 'Concurrency or Bust.',         stance: "No subdivisions where the schools and roads can't keep up." },
    ...
    events: [
      ...
      { date_label:'May 31', day_label:'Sun', time_label:'10:00 am',       title:'Coffee on the Porch',         location:'James Island, Avondale',             host:'Carol Wieters',         tag:null },
      { date_label:'Jun 02', day_label:'Tue', time_label:'6:00 pm',        title:'Folly Beach Town Hall',       location:'Folly River Park Pavilion',          host:'Open to all',           tag:null },
      { date_label:'Jun 04', day_label:'Thu', time_label:'7:00 pm',        title:'Healthcare & Aging Panel',    location:"St. Andrew's Episcopal, James Is.",  host:'With Dr. Lila Pope',    tag:null },
      ...
      { date_label:'Jun 08', day_label:'Mon', time_label:'6:30 pm',        title:'Election Eve Rally',          location:'Riverfront Park, North Charleston',  host:'With Speaker Smith',    tag:null },
    ],
    news: [
      ...
      { tag:'Press', date_label:'Apr 02, 2026', source:'Live 5 News',    title:'Speaker Smith endorses Garmon for HD-115.' },
    ],
    volunteer: [
