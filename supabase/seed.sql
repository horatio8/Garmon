...
set data = jsonb_build_object(
  ...
  'aboutArc1',       'Johnnie''s life began in Greensboro, North Carolina — with a partial cleft palate and a speech impediment so pronounced that even his own parents struggled to understand him. After his parents divorced, his mother raised him and his three older sisters in government housing, relying on the Food Bank to eat and hand-me-downs to dress. He was the only white kid in the neighborhood and the only kid in school who couldn''t pronounce his own name. He learned early what it meant to be misunderstood.',
  ...
  'aboutFamily',     'Married thirty-one years to Kelley — his childhood sweetheart, who returned to his life after his first marriage ended in divorce and formally adopted his oldest daughter as her own. Together they have raised three daughters: Caroline, Reagan, and Zoe. Members of James Island Christian Church. Little League coach for nine seasons.',
